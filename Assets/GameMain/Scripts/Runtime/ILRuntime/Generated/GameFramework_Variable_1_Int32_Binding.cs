...
{
    unsafe class GameFramework_Variable_1_Int32_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(GameFramework.Variable<System.Int32>);
            args = new Type[]{};
        ...
        static StackObject* get_Value_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            GameFramework.Variable<System.Int32> instance_of_this_method = (GameFramework.Variable<System.Int32>)typeof(GameFramework.Variable<System.Int32>).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
