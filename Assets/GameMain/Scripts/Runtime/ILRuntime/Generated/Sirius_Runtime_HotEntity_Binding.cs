...
{
    unsafe class Sirius_Runtime_HotEntity_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(Sirius.Runtime.HotEntity);
            args = new Type[]{};
            ...
            args = new Type[]{};
            method = type.GetMethod("get_HotLogicInstance", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, get_HotLogicInstance_4);
        ...
        static StackObject* get_Position_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            Sirius.Runtime.HotEntity instance_of_this_method = (Sirius.Runtime.HotEntity)typeof(Sirius.Runtime.HotEntity).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
        ...
        static StackObject* get_HotLogicInstance_4(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 1);
            ...
            var result_of_this_method = instance_of_this_method.HotLogicInstance;
