...
{
    unsafe class UnityGameFramework_Runtime_BaseComponent_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(UnityGameFramework.Runtime.BaseComponent);
            args = new Type[]{};
        ...
        static StackObject* ResetNormalGameSpeed_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            UnityGameFramework.Runtime.BaseComponent instance_of_this_method = (UnityGameFramework.Runtime.BaseComponent)typeof(UnityGameFramework.Runtime.BaseComponent).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
