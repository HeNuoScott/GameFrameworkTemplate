...
{
    unsafe class Sirius_Runtime_HotLog_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(Sirius.Runtime.HotLog);
            ...
            args = new Type[]{typeof(System.String), typeof(System.Object[])};
            method = type.GetMethod("Error", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, Error_4);
            args = new Type[]{typeof(System.String)};
            method = type.GetMethod("Info", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, Info_5);
            args = new Type[]{typeof(System.Object)};
            method = type.GetMethod("Debug", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, Debug_6);
            args = new Type[]{typeof(System.String)};
            method = type.GetMethod("Warning", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, Warning_7);
        ...
        static StackObject* Error_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            Sirius.Runtime.HotLog.Error(@message);
        ...
        static StackObject* Debug_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            Sirius.Runtime.HotLog.Debug(@message);
        ...
        static StackObject* Warning_2(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            Sirius.Runtime.HotLog.Warning(@format, @args);
        ...
        static StackObject* Info_3(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            Sirius.Runtime.HotLog.Info(@format, @args);

            return __ret;
        }

        static StackObject* Error_4(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 2);
            ...
            Sirius.Runtime.HotLog.Error(@format, @args);
        ...
        static StackObject* Info_5(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            Sirius.Runtime.HotLog.Info(@message);

            return __ret;
        }

        static StackObject* Debug_6(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 1);
        ...
        static StackObject* Warning_7(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 1);
            ...
            Sirius.Runtime.HotLog.Warning(@message);
