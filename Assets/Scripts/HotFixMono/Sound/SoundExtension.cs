...
namespace GameHotFix
{
    public static class SoundExtension
    {
        ...
        public static void Mute(this SoundComponent soundComponent, string soundGroupName, bool mute)
        {
            ...
            GameEntry.Setting.SetBool(Utility.Text.Format(GameMain.Constant.Setting.SoundGroupMuted, soundGroupName), mute);
        ...
        public static void SetVolume(this SoundComponent soundComponent, string soundGroupName, float volume)
        {
            ...
            GameEntry.Setting.SetFloat(Utility.Text.Format(GameMain.Constant.Setting.SoundGroupVolume, soundGroupName), volume);
            GameEntry.Setting.Save();
        }
    }
}
