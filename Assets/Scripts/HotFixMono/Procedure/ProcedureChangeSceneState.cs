...
namespace Sirius
{
    public class ProcedureChangeSceneState : FsmState<FSMProcedure>
    {
        ...
        protected override void OnUpdate(IFsm<FSMProcedure> procedureOwner, float elapseSeconds, float realElapseSeconds)
        {
            ...
            if (m_ChangeToMenu)
            {
                ChangeState<ProcedureMenuState>(procedureOwner);
            }
            else
            {
                ChangeState<ProcedureMainState>(procedureOwner);
            }
        }
